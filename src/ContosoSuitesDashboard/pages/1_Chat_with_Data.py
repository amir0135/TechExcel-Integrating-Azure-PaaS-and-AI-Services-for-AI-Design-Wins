...
def create_chat_completion(messages):
    ...
    - The Azure AI Search endpoint, key, and index name are also stored in Streamlit secrets."""
    ...
    # Retrieve Azure AI Search secrets from the Streamlit secret store
    ...
    # Create and return a new chat completion request with Azure AI Search as a data source
