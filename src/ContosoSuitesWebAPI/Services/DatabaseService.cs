...
namespace ContosoSuitesWebAPI.Services
{
    ...
    public class DatabaseService(string connectionString) : IDatabaseService
    {
        ...
        public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
            [Description("The ID of the hotel")] int hotelId,
            [Description("Minimum start date for the booking.")] DateTime dt
        )
        {
        ...
        [KernelFunction]
        [Description("Get all bookings that do not have an associated hotel room.")]
        ...
        [KernelFunction]
        [Description("Get all bookings that have more than one hotel room associated.")]
